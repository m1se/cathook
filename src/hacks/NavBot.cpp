...
bool meleeAttack(int slot, std::pair<CachedEntity *, float> &nearest)
{
    ...
    if (hacks::tf2::misc_aimbot::charge_aim && re::C_BasePlayer::GetEquippedDemoShield(raw_local) && re::CTFPlayerShared::GetChargeMeter(re::CTFPlayerShared::GetPlayerShared(raw_local)) == 100.0f)
    {
